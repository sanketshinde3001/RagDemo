...
export default function VoiceInput({ onTranscript, disabled = false }: VoiceInputProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {transcript && (
        <div className="flex-1 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg text-sm text-gray-700 dark:text-gray-300 animate-fade-in">
      ...
      {/* Error display */}
      {error && (
        <div className="flex-1 px-3 py-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-sm text-red-700 dark:text-red-300">
          ❌ {error}
        </div>
      )}
    </div>
